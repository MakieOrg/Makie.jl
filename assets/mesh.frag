...
void main() {
    vec4 real_color = get_color(color, frag_uv);
    vec3 color = blinnphong(frag_normal, frag_position, frag_lightdir, real_color.xyz);
    gl_FragColor = vec4(color, real_color.a);
}
