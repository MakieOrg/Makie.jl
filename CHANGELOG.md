...
- Fixed a potential source of sporadic text corruption in CairoMakie (glyphs rendered at a wrong scale or position) by keeping Cairo font faces alive instead of recreating them per draw call.
