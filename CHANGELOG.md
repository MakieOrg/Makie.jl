...
- Added `rasterize` as a generic plot attribute, fixed `rasterize` getting fixed to a `Bool` or `Int` and fix rasterize warning in recipes [#5783](https://github.com/MakieOrg/Makie.jl/pull/5783)
