...
- Added `preferred_axis_attributes(plot, axis_type)` as an overloadable function for specifying default axis attributes. The are used when an axis is generated by a non-mutating `plot()` call. [#5375](https://github.com/MakieOrg/Makie.jl/pull/5375)
