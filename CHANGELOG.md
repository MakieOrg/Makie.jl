...
- Added `open_circle`, `open_rect`, `open_diamond`, `open_utriangle`, `open_rtriangle`, `open_dtriangle` and `open_ltriangle` convenience functions for open marker shapes [#4935](https://github.com/MakieOrg/Makie.jl/pull/4935)
