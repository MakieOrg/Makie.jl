...
The name Makie (we pronounce it Mah-kee) is derived from the Japanese decoration technique [maki-e](https://en.wikipedia.org/wiki/Maki-e), which uses lacquer to make designs with gold and silver powder.
