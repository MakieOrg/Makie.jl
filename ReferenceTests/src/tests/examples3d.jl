...
@reference_test "Connected Sphere" begin
    ...
    println(linepos.indices)
    fig, ax, lineplot = lines(
        linepos, linewidth=1, color=:black, transparency=true,
        figure = (size = (5000, 5000),)
    )
    scatter!(
