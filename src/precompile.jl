function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(axis2d!)),NamedTuple{(:ticks,), Tuple{NamedTuple{(:ranges, :labels), Tuple{Automatic, Automatic}}}},typeof(axis2d!),Scene,Vararg{Any, 100}})   # time: 3.2898602
    ...
    Base.precompile(Tuple{Type{Axis2D{ArgType} where ArgType},Scene,Attributes,Tuple{Observable{GeometryBasics.HyperRectangle{3, Float32}}},Observable{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}}})   # time: 0.164594
    ...
    Base.precompile(Tuple{typeof(draw_axis2d),Annotations{Tuple{Vector{Tuple{String, Point{2, Float32}}}}},Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any})   # time: 0.050706662
    ...
    Base.precompile(Tuple{Type{LineSegments{ArgType} where ArgType},Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Attributes,Tuple{Observable{Vector{Point{2, Float32}}}},Observable{Tuple{Vector{Point{2, Float32}}}}})   # time: 0.03720287
    ...
    Base.precompile(Tuple{typeof(TextBuffer),Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Type{Point2{T} where T}})   # time: 0.034710467
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(LinesegmentBuffer)),NamedTuple{(:transparency, :linestyle), Tuple{Bool, Observable{Nothing}}},typeof(LinesegmentBuffer),Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Type{Point2{T} where T}})   # time: 0.029377935
    Base.precompile(Tuple{Core.kwftype(typeof(plot!)),NamedTuple{(:ticks,), Tuple{NamedTuple{(:ranges, :labels), Tuple{Automatic, Automatic}}}},typeof(plot!),Type{Axis2D{ArgType} where ArgType},Scene,Attributes,Observable{GeometryBasics.HyperRectangle{3, Float32}}})   # time: 0.029010275
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(LinesegmentBuffer)),NamedTuple{(:transparency, :linestyle), Tuple{Bool, Observable{Any}}},typeof(LinesegmentBuffer),Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Type{Point2{T} where T}})   # time: 0.028078713
    ...
    Base.precompile(Tuple{typeof(default_theme),Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Type{Annotations{Tuple{Vector{Tuple{String, Point{2, Float32}}}}}}})   # time: 0.01716587
    ...
    Base.precompile(Tuple{Type{Annotations{ArgType} where ArgType},Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Attributes,Tuple{Observable{Vector{String}}, Observable{Vector{Point{2, Float32}}}},Observable{Tuple{Vector{Tuple{String, Point{2, Float32}}}}}})   # time: 0.005644192
    ...
    Base.precompile(Tuple{typeof(push!),Scene,Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}}})   # time: 0.002954412
    ...
    Base.precompile(Tuple{Type{Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}}},Scene,Transformation,Attributes,Tuple{Observable{GeometryBasics.HyperRectangle{3, Float32}}},Tuple{Observable{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}}})   # time: 0.002173788
    ...
    Base.precompile(Tuple{typeof(default_theme),Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Type{LineSegments{Tuple{Vector{Point{2, Float32}}}}}})   # time: 0.001372238
    ...
    Base.precompile(Tuple{Type{LineSegments{Tuple{Vector{Point{2, Float32}}}}},Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Transformation,Attributes,Tuple{Observable{Vector{Point{2, Float32}}}},Tuple{Observable{Vector{Point{2, Float32}}}}})   # time: 0.001263983
    Base.precompile(Tuple{typeof(getindex),Scene,Type{Axis}})   # time: 0.001070641
    Base.precompile(Tuple{Type{Annotations{Tuple{Vector{Tuple{String, Point{2, Float32}}}}}},Axis2D{Tuple{Tuple{Tuple{Float32, Float32}, Tuple{Float32, Float32}}}},Transformation,Attributes,Tuple{Observable{Vector{String}}, Observable{Vector{Point{2, Float32}}}},Tuple{Observable{Vector{Tuple{String, Point{2, Float32}}}}}})   # time: 0.001064846
