_ORIG_LOAD_PATH = copy(LOAD_PATH)
push!(LOAD_PATH, "../CairoMakie/")
    ...
    @testset "Video encoding" begin
        ...
        @testset "Warnings" begin
            ...
            for (; kwarg, value, warn_fmts, no_warn_fmts) in warn_tests
                ...
                warning_re = Regex("^`$(kwarg)` \\(with value `$(repr(value))`\\) was passed")
...
copyto!(LOAD_PATH, _ORIG_LOAD_PATH)
resize!(LOAD_PATH, length(_ORIG_LOAD_PATH))
