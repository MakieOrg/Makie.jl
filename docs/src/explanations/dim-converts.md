...
You can also set the formatter for units in axis labels.
It accepts either a `Format.jl` compatible String or a function that acts on the output generated by the dimensional conversion.
...
The dimensional conversion are kept track of in the (generated) axis.
