...
To create a horizontal layout containing a label, a slider, and a value label, use the convenience function [`MakieLayout.labelslider!`](@ref).
...
If you want to programmatically move the slider, use the function [`MakieLayout.set_close_to!`](@ref).
