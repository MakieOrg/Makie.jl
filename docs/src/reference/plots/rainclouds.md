...
### Basic raincloud with histogram clouds
...
### Vertical raincloud with violin plots
...
### Raincloud with right-aligned violin plots and limits
...
### Comprehensive raincloud comparison
