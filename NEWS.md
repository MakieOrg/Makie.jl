...
- allow linewidth per segment [#992](https://github.com/JuliaPlots/Makie.jl/pull/992)
- new 3d camera [#1024](https://github.com/JuliaPlots/Makie.jl/pull/1024)
- apply all transformations to surface [#1070](https://github.com/JuliaPlots/Makie.jl/pull/1070)
- make ZoomRect customizable [#1104](https://github.com/JuliaPlots/Makie.jl/pull/1104)
- correctly render reversed heatmap with CairoMakie (`heatmap(1:10, 10:-1:1, rand(10, 10))`) [#1100](https://github.com/JuliaPlots/Makie.jl/pull/1100)
