...
function plot!(p::T) where T <: RecipePlot
    ...
    # ChangeObservable(1) is a dummy observable for dispatch.
    lift(ChangeObservable(1), p.attributes, p.converted, p.converted..., values(p.attributes)...) do _, attrs, args, __lifted...
