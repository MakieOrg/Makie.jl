...
function plot_series_annotations!(plt, args, pt, plotattributes)
    ...
    return annotations!(plt, strs, positions; fontsize = fontsize / 30, align = (:center, :center), color = get(plotattributes, :textcolor, :black))
...
function plot_annotations!(plt, args, pt, plotattributes)
    ...
    return annotations!(plt, strs, positions; fontsize = fontsizes ./ 80, align = (:center, :center), color = get(plotattributes, :textcolor, :black))
