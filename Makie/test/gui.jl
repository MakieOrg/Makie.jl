...
@testset "Legend attributes" begin
    ...
    f, ax, pl = scatter(rand(10), label="My Scatter";
    ...
    f2, ax2, pl2 = scatter(rand(10), label="Grid Legend";
    ...
    f3, ax3, pl3 = scatter(rand(10), label="Margin Test";
...
@testset "Colorbar attributes" begin
    ...
    f2, ax2, pl2 = scatter(rand(10), color=1:10;
    ...
    f3, ax3, pl3 = scatter(rand(10), color=1:10;
    ...
    f4, ax4, pl4 = heatmap(rand(10, 10), colormap=:viridis;
...
@testset "figure keyword in plot calls" begin
    # Test figure=(; gui=true, legend=(...))
    f, ax, pl = scatter(rand(10), rand(10), label="Test";
    ...
    f2, ax2, pl2 = scatter(rand(10), rand(10), color=1:10;
    ...
    f3, ax3, pl3 = scatter(rand(10), label="test";
        figure=(; legend=true))
    Makie.add_gui!(f3, ax3, pl3)
...
@testset "GUI with various plot types" begin
    ...
    f2, ax2, pl2 = heatmap(rand(10, 10), colormap=:heat;
        figure=(; colorbar=(position=[1, 2],)))
    Makie.add_gui!(f2, ax2, pl2)
    @test !isnothing(f2.gui_state.colorbar)
    # Colorbar should have a colormap (derived from plot)
    ...
    f3, ax3, pl3 = series(rand(5, 10), labels=["a", "b", "c", "d", "e"];
        figure=(; legend=true))
    Makie.add_gui!(f3, ax3, pl3)
    @test !isnothing(f3.gui_state.legend)

    # Scatter with both legend and colorbar
    f4, ax4, pl4 = scatter(rand(10), color=1:10, label="Colored Points";
...
@testset "remove_gui! cleans up state" begin
    f, ax, pl = scatter(rand(10), color=1:10, label="test";
