...
function show_data(inspector::DataInspector, hs::HeatmapShader, idx, pp::Image)
    ...
    # Indices get ignored anyways, since they're calculated from the mouse
    # position + xrange/yrange of the heatmap. If we don't overwrite this here,
    # show_data will get called on `pp`, which will use the small resampled version
