...
img1 = colorbuffer(scene1; backend=TraceMakie)
...
img2 = colorbuffer(scene2; backend=TraceMakie)
...
img3 = colorbuffer(scene3; backend=TraceMakie)
...
img4 = colorbuffer(scene4; backend=TraceMakie)
...
img5 = colorbuffer(scene5; backend=TraceMakie)
...
img6 = colorbuffer(s6; backend=TraceMakie)
