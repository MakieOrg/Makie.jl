...
function glGetAttachedShaders(program::GLuint)
    ...
    return shaders[1:first(length_written)]
end
...
function glDeleteTextures(id::GLuint)
    return glDeleteTextures(1, Ref(id))
end

function glDeleteVertexArrays(id::GLuint)
    return glDeleteVertexArrays(1, Ref(id))
end

function glDeleteBuffers(id::GLuint)
    return glDeleteBuffers(1, Ref(id))
end
...
Makie.@noconstprop function glTexImage(
        ttype::GLenum, level::Integer, internalFormat::GLenum, w::Integer,
