# Interactive Volume Rendering with RayMakie
...
Create an interactive volume rendering dashboard with RayMakie.
...
function volume_interactive_dashboard(qlt, grid_extent, cloud_frames;
    ...
    controls_handle = RayMakie.render_interactive(ax.scene;
        max_depth=max_depth,
...
"""
Create a simple volume scene for benchmarking RayMakie rendering.
