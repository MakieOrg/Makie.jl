...
using MeshIO, FileIO, GeometryBasics, RayMakie, Makie, Hikari
using AMDGPU
...
let
    ...
    @time Makie.record(s, "lego_$(name).mp4", zip(translations, angles); backend=RayMakie) do (translation, angle)
