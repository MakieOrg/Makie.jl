import{_ as p,c as e,j as a,a as n,G as t,a5 as i,B as h,o as r}from"./chunks/framework.DhIibvLa.js";const k="/previews/PR4399/assets/f28cb94.Dr8xGVk0.png",o="/previews/PR4399/assets/8145051.BhZqk3d2.png",c="/previews/PR4399/assets/2703608.CQ67Hvw1.png",d="/previews/PR4399/assets/b67b9d0.BT3Bltbj.png",v=JSON.parse('{"title":"hist","description":"","frontmatter":{},"headers":[],"relativePath":"reference/plots/hist.md","filePath":"reference/plots/hist.md","lastUpdated":null}'),g={name:"reference/plots/hist.md"},E={class:"jldocstring custom-block",open:""};function u(b,s,y,f,m,F){const l=h("Badge");return r(),e("div",null,[s[3]||(s[3]=a("h1",{id:"hist",tabindex:"-1"},[n("hist "),a("a",{class:"header-anchor",href:"#hist","aria-label":'Permalink to "hist"'},"​")],-1)),a("details",E,[a("summary",null,[s[0]||(s[0]=a("a",{id:"Makie.hist-reference-plots-hist",href:"#Makie.hist-reference-plots-hist"},[a("span",{class:"jlbinding"},"Makie.hist")],-1)),s[1]||(s[1]=n()),t(l,{type:"info",class:"jlObjectType jlFunction",text:"Function"})]),s[2]||(s[2]=i('<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">hist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(values)</span></span></code></pre></div><p>Plot a histogram of <code>values</code>.</p><p><strong>Plot type</strong></p><p>The plot type alias for the <code>hist</code> function is <code>Hist</code>.</p><p><a href="https://github.com/MakieOrg/Makie.jl/blob/b48b4c4f99753ef7c9da27729e96a6c890b87c6b/MakieCore/src/recipes.jl#L466-L537" target="_blank" rel="noreferrer">source</a></p>',5))]),s[4]||(s[4]=i(`<h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to &quot;Examples&quot;">​</a></h2><a id="example-f28cb94"></a><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> GLMakie</span></span>
...
<span class="line"><span>│   material</span></span>
<span class="line"><span>│   diffuse</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span></code></pre></div><img src="`+k+`" width="600px" height="450px"><h4 id="Histogram-with-labels" tabindex="-1">Histogram with labels <a class="header-anchor" href="#Histogram-with-labels" aria-label="Permalink to &quot;Histogram with labels {#Histogram-with-labels}&quot;">​</a></h4><p>You can use all the same arguments as <a href="/previews/PR4399/reference/plots/barplot#barplot"><code>barplot</code></a>: <a id="example-8145051"></a></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> CairoMakie</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">data </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> randn</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1000</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">     strokewidth </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0.5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, strokecolor </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:black</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">0.5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">), color </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> :values</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: Not all attributes valid for ::Mesh are given in poly(). Missing ones include:</span></span>
<span class="line"><span>│   specular</span></span>
<span class="line"><span>│   matcap</span></span>
<span class="line"><span>│   backlight</span></span>
<span class="line"><span>│   uv_transform</span></span>
...
<span class="line"><span>│   material</span></span>
<span class="line"><span>│   diffuse</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span></code></pre></div><img src="`+c+`" width="600px" height="450px"><h4 id="Using-statistical-weights" tabindex="-1">Using statistical weights <a class="header-anchor" href="#Using-statistical-weights" aria-label="Permalink to &quot;Using statistical weights {#Using-statistical-weights}&quot;">​</a></h4><a id="example-b67b9d0"></a><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> CairoMakie</span></span>
