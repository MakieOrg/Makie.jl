import{_ as a,c as i,a5 as n,o as e}from"./chunks/framework.DhIibvLa.js";const p="/previews/PR4399/assets/4adb559.zfs5igSc.png",t="/previews/PR4399/assets/4adb559.zfs5igSc.png",l="/previews/PR4399/assets/27c021f.GVSzL6Gi.png",y=JSON.parse('{"title":"Wrapping existing recipes for new types","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/wrap-existing-recipe.md","filePath":"tutorials/wrap-existing-recipe.md","lastUpdated":null}'),h={name:"tutorials/wrap-existing-recipe.md"};function r(k,s,o,c,d,g){return e(),i("div",null,s[0]||(s[0]=[n(`<h1 id="Wrapping-existing-recipes-for-new-types" tabindex="-1">Wrapping existing recipes for new types <a class="header-anchor" href="#Wrapping-existing-recipes-for-new-types" aria-label="Permalink to &quot;Wrapping existing recipes for new types {#Wrapping-existing-recipes-for-new-types}&quot;">​</a></h1><h2 id="introduction" tabindex="-1">Introduction <a class="header-anchor" href="#introduction" aria-label="Permalink to &quot;Introduction&quot;">​</a></h2><p>There are multiple ways one can extend the functionalities of Makie, for example, user can define a totally new plot type from scratch. Another common use case is to &quot;teach&quot; Makie how to draw user-defined data structure for different existing recipes.</p><p>In this tutorial, we will show you how to teach Makie to plot our custom data type <code>MyHist</code> that is a simplified histogram type.</p><p>To define recipes, one only needs to use <code>MakieCore.jl</code>, this is especially handy when you&#39;re a package developer and want to avoid depend on the full Makie.jl. For demonstration purpose, this tutorial will use <code>CairoMakie.jl</code> to visualize things as we go.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> MakieCore, CairoMakie</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">barplot</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(h)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: Not all attributes valid for ::Mesh are given in poly(). Missing ones include:</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">hist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(h; color</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:red</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, direction</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">:x</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>┌ Warning: Not all attributes valid for ::Mesh are given in poly(). Missing ones include:</span></span>
<span class="line"><span>│   specular</span></span>
<span class="line"><span>│   matcap</span></span>
<span class="line"><span>│   backlight</span></span>
<span class="line"><span>│   uv_transform</span></span>
...
<span class="line"><span>│   material</span></span>
<span class="line"><span>│   diffuse</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span></code></pre></div><img src="`+t+`" width="600px" height="450px"><p>This almost works, but we see that the keyword arguments are not passed to the <code>barplot!</code> function. To handle these attributes properly, we need to override/merge the default attributes of the underlying plot type (in this case, <code>BarPlot</code>) with the user-passed attributes. Since Makie 0.21, <code>shared_attributes</code> was introduced for this use case, which extracts all valid attributes for the target plot type: <a id="example-27c021f"></a></p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">function</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Makie</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">plot!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(plot</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">::</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">Hist{&lt;:Tuple{&lt;:MyHist}}</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)</span></span>
...
<span class="line"><span>│   diffuse</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span>
<span class="line"><span>┌ Warning: Not all attributes valid for ::Plot{Makie.barplot} are given in hist(). Missing ones include:</span></span>
<span class="line"><span>│   transparency</span></span>
<span class="line"><span>│   alpha</span></span>
<span class="line"><span>│   colormap</span></span>
<span class="line"><span>│   space</span></span>
<span class="line"><span>│   ssao</span></span>
<span class="line"><span>│   label_align</span></span>
<span class="line"><span>│   transformation</span></span>
<span class="line"><span>│   depth_shift</span></span>
<span class="line"><span>│   color_over_bar</span></span>
<span class="line"><span>│   fxaa</span></span>
<span class="line"><span>│   width</span></span>
<span class="line"><span>│   dodge</span></span>
<span class="line"><span>│   visible</span></span>
<span class="line"><span>│   colorscale</span></span>
<span class="line"><span>│   n_dodge</span></span>
<span class="line"><span>│   highclip</span></span>
<span class="line"><span>│   stack</span></span>
<span class="line"><span>│   label_position</span></span>
<span class="line"><span>│   nan_color</span></span>
<span class="line"><span>│   label_rotation</span></span>
<span class="line"><span>│   overdraw</span></span>
<span class="line"><span>│   dodge_gap</span></span>
<span class="line"><span>│   colorrange</span></span>
<span class="line"><span>│   inspectable</span></span>
<span class="line"><span>│   color_over_background</span></span>
<span class="line"><span>│   lowclip</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span>
<span class="line"><span>┌ Warning: Not all attributes valid for ::Mesh are given in poly(). Missing ones include:</span></span>
<span class="line"><span>│   specular</span></span>
<span class="line"><span>│   matcap</span></span>
...
<span class="line"><span>│   material</span></span>
<span class="line"><span>│   diffuse</span></span>
<span class="line"><span>└ @ Makie ~/work/Makie.jl/Makie.jl/src/utilities/utilities.jl:618</span></span></code></pre></div><img src="`+l+'" width="600px" height="450px">',24)]))}const u=a(h,[["render",r]]);export{y as __pageData,u as default};
