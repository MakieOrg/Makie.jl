...
<img src="./1bf8f30.png" width="600px" height="450px"/>


You can customize the markers that indicate the bar directions.
<a id="example-44bc08f" />
...
<img src="./44bc08f.png" width="600px" height="450px"/>


If the `dodge` attribute is provided, bars are stacked by `dodge`.
<a id="example-db762e3" />
...
<img src="./22fd1c2.png" width="600px" height="450px"/>


The color of the final bars in the background can be modified.
<a id="example-33bba2b" />
...
<img src="./33bba2b.png" width="600px" height="450px"/>


You can also specify to stack grouped waterfall plots by `x`.
<a id="example-4ee0c5e" />
...
<img src="./4ee0c5e.png" width="600px" height="450px"/>
