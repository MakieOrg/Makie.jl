...
| Package                                                    | Description                                                                                          |
|:---------------------------------------------------------- |:---------------------------------------------------------------------------------------------------- |
| [GLMakie](/explanations/backends/glmakie#GLMakie)          | GPU-powered, interactive 2D and 3D plotting in standalone `GLFW.jl` windows.                         |
| [CairoMakie](/explanations/backends/cairomakie#CairoMakie) | `Cairo.jl` based, non-interactive 2D (and some 3D) backend  for publication-quality vector graphics. |
| [WGLMakie](/explanations/backends/wglmakie#WGLMakie)       | WebGL-based interactive 2D and 3D plotting that runs within browsers.                                |
| [RPRMakie](/explanations/backends/rprmakie#RPRMakie)       | An experimental ray tracing backend.                                                                 |


### Activating Backends {#Activating-Backends}
