...
open(joinpath(@OUTPUT, "example_22fd5a35_size.txt"), "w") do io # hide
    print(io, sz[1], " ", sz[2])                       # hide
end                                                    # hide
save(joinpath(@OUTPUT, "example_22fd5a35.png"), __result; px_per_unit = 2, pt_per_unit = 0.75, ) # hide
save(joinpath(@OUTPUT, "example_22fd5a35.svg"), __result; px_per_unit = 2, pt_per_unit = 0.75, ) # hide
nothing # hide