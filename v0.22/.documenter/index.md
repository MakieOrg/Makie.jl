...
# Welcome to Makie! {#Welcome-to-Makie!}
...
Makie offers four different backends (more info under [What is a backend](/explanations/backends/backends#What-is-a-backend)). We suggest GLMakie for GPU-accelerated, interactive plots, and CairoMakie for static vector graphics.
- [GLMakie](/explanations/backends/glmakie#GLMakie) (OpenGL based, interactive)
  
- [CairoMakie](/explanations/backends/cairomakie#CairoMakie) (Cairo based, static vector graphics)
  
- [WGLMakie](/explanations/backends/wglmakie#WGLMakie) (WebGL based, displays plots in the browser)
  
- [RPRMakie](/explanations/backends/rprmakie#RPRMakie) (Experimental ray-tracing using RadeonProRender)
...
If you are new to Makie, have a look at [Getting started](/tutorials/getting-started#Getting-started).

For inspiration, visit [Beautiful Makie](https://beautiful.makie.org/) for a collection of interesting plots.

An overview of third-party packages that expand Makie&#39;s capabilities is at [Ecosystem](/ecosystem#Ecosystem).

## Citing Makie {#Citing-Makie}
