...
# How to match figure size, font sizes and dpi {#How-to-match-figure-size,-font-sizes-and-dpi}
...
We assume the convention that Makie&#39;s unitless figure size is actually equivalent to CSS pixels. For a deeper explanation why, check the section [Figure size and resolution](/explanations/figure#Figure-size-and-resolution).
