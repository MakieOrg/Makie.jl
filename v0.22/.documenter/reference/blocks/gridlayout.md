...
## Setting column and row sizes correctly {#Setting-column-and-row-sizes-correctly}
...
<img src="./db5c3cd.png" width="600px" height="450px"/>
...
<img src="./79f4d6b.png" width="600px" height="450px"/>
...
When a `GridLayout` is solved, it looks at the content in each row or column and checks if it reports a fixed size. Many objects can report their own width or height because their content has a specific size, such as `Label`. Other objects are often used with a user-set width or height, for example `Colorbar(scene, width = 30)`. In this case, the `GridLayout` can also see that the colorbar has a width of 30 units and fit the column width to that value. Objects like `Axis` on the other hand are usually not set to a specific size.
...
<img src="./d7b0bcd.png" width="600px" height="450px"/>
...
<img src="./b5ebded.png" width="600px" height="450px"/>
...
<img src="./524924c.png" width="600px" height="450px"/>
...
<img src="./7c1fe22.png" width="800px" height="800px"/>


## Spanned Placement {#Spanned-Placement}
...
<img src="./5867f17.png" width="600px" height="450px"/>


## Adding rows and columns by indexing {#Adding-rows-and-columns-by-indexing}
...
<img src="./781581b.png" width="800px" height="800px"/>


If you have rows from 1 to 3 and index into row 0, the rows now range from 0 to 3. If you then index into row -1, the rows range from -1 to 3 and so on. This behavior has changed since GridLayoutBase.jl `v0.7.0`.
<a id="example-b9a10f3" />
...
<img src="./b9a10f3.png" width="800px" height="800px"/>


## Trimming empty rows and columns {#Trimming-empty-rows-and-columns}
...
<img src="./10aebc1.png" width="600px" height="450px"/>
...
<img src="./b5d1c7c.png" width="600px" height="450px"/>


We can get rid of the unused space with `trim!`:
<a id="example-247a27a" />
...
<img src="./247a27a.png" width="600px" height="450px"/>


## Tweaking space between rows and columns {#Tweaking-space-between-rows-and-columns}

You can use `rowgap!` and `colgap!` to change the spacing between rows or columns respectively.
<a id="example-797711e" />
...
<img src="./b74926a.png" width="600px" height="450px"/>
